...
（以下引用了 [QSCTech/zju-icicles](https://github.com/QSCTech/zju-icicles) ）
...
来自大家的关注、维护和贡献，才是让这个北京师范大学独有的攻略本继续存在的动力~
...
如果你认为本仓库的一些文件侵犯了您的权益，请 [向我们发送邮件](mailto:zn.qi@outlook.com) 。我们将会从仓库中彻底清除这些文件。
